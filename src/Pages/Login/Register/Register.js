                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <form onSubmit={handleLoginSubmit}>
                                <input onBlur={handleOnBlur} name="name" className='form-control my-3 rounded-pill' type="text" placeholder='Name' />
                                <input onBlur={handleOnBlur} name="name" className='form-control my-3 rounded-pill' type="text" placeholder='Name' />
                                <input onBlur={handleOnBlur} name="password" className='form-control my-3 rounded-pill' type="password" placeholder='Password' />
                                <input className='btn btn-info w-50 btn-outline-secondary text-white rounded-pill' type="submit" value="REGISTER" />
                                <div className=' mt-3'>
                                <span >Already Registerd? </span>
                                <NavLink
                                to="/login" className="text-decoration-none fw-bold text-start">
                                <span className=' mt-3 text-info'>Sign in</span>
                            </NavLink>
                                </div>
